...
function Room57(number, width, height, length) {
  ...
  };//это функциональное выражение ограничено функцией Room57
  student('Sasha');

  const frontSide = new Board('2 metr', '1,3 metr');//её область видимости ограничена функцией-конструктором Room57
